...
const SurveysService = __importStar(require("../../services/surveys.service"));
...
describe("Surveys Controller", () => {
    ...
    describe("createSurvey", () => {
        it("should create a survey and return status 201", async () => {
            ...
            const response = await (0, surveys_controller_1.createSurvey)(event);
    ...
    describe("getSurveys", () => {
        it("should return surveys for a project with status 200", async () => {
            ...
            const response = await (0, surveys_controller_1.getSurveys)(event);
    ...
    describe("addQuestion", () => {
        it("should add a question to a survey and return status 201", async () => {
            ...
            const response = await (0, surveys_controller_1.addQuestion)(event);
            expect(response.statusCode).toBe(201);
            expect(JSON.parse(response.body)).toEqual({
    ...
    describe("runSurvey", () => {
        it("should run a survey and return status 200", async () => {
            ...
            const response = await (0, surveys_controller_1.runSurvey)(event);
            expect(response.statusCode).toBe(200);
    ...
    describe("deleteSurvey", () => {
        it("should delete a survey and return status 200", async () => {
            ...
            const response = await (0, surveys_controller_1.deleteSurvey)(event);
            expect(response.statusCode).toBe(200);
